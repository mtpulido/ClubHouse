    ...
    <div className="new-round-container">
      ...
      >
        <Step key="1" className={classes.stepContent}>
          <StepLabel StepIconProps={{ classes: { root: iconClasses.root } }} classes={activeStep === 0 ?{ label: classes.step_label_root } : {}}>
            Round Info
          </StepLabel>
        ...
        <Step key="2">
          <StepLabel StepIconProps={{ classes: { root: iconClasses.root } }} classes={activeStep === 1 ?{ label: classes.step_label_root } : {}}>
            Long Game
          </StepLabel>
          <StepContent>
        ...
        <Step key="3">
          <StepLabel StepIconProps={{ classes: { root: iconClasses.root } }} classes={activeStep === 2 ?{ label: classes.step_label_root } : {}}>
            Short Game
          </StepLabel>
          <StepContent>
          <div className="step-two-container">
