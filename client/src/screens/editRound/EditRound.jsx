...
const EditRound = (props) => {
  ...
  const [newRound, setNewRound] = useState({
    ...
    holes: currentUser?.recentRounds[id].holes,
    score: currentUser?.recentRounds[id].score,
    fairwaysHit: currentUser?.recentRounds[id].fairwaysHit,
    possibleFairways: currentUser?.recentRounds[id].possibleFairways,
    putts: currentUser?.recentRounds[id].putts,
    greens: currentUser?.recentRounds[id].greens,
  ...
  const handleSubmit = (event) => {
    ...
    props.handleEditRound(newRound);
  };
